...
@Composable
internal fun HumidityWidgetContent(
    currentState: HumidityWidgetModel,
    ...
    Box(
        ...
        Column(
            ...
            Image(
                provider = ImageProvider(io.wookoo.design.system.R.drawable.ic_humidity),
                contentDescription = null,
                modifier = GlanceModifier.size(size_100)
                    .padding(bottom = small)
            )
            Text(
                text = currentState.humidity,
                modifier = GlanceModifier.fillMaxWidth(),
                style = TextStyle(
